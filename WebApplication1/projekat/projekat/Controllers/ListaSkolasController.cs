    ...
    public class ListaSkolasController : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            ...
            return View(listaSkola);
                ...
                public ActionResult Create([Bind(Include = "idS,NazivSkole,AdresaReg,Opstina,PostanskiBroj,MaticniBroj,pib,BrojRacuna,WebStranica,KontaktOsobaFK,SlikaPecat,Beleske")] ListaSkola listaSkola)
                {
        ...
        public ActionResult AddUserAdmin(projekat.Models.login userModel)
        {
            ...
            return View("SuccessAddUserAdmin", userModel);
        ...
        public ActionResult EditKorisnika([Bind(Include ="id,username,password,userType")] login logins)
        {
            ...
            ViewBag.KontaktOsobaFK = new SelectList(db.logins, "userType","userType",logins.userType);
            return View(logins);
        }
        ...
        {
            return View("ListaSkolasControler");
        }*/
